	...
	<div class="monitoring">
        ...
        <div class="box">
            <ul>
                ...
                <li v-for="data in dataList" v-if="data.id!=999999">
                ...
                <!-- <li>
					<router-link :to="{path: '/RiskAssessment/'+4+'/肺癌风险评估'}" >
					<img src="../assets/images/c33_icon6.png" alt="">
                    <span>肺癌风险评估</span>
					</router-link>
                </li>
                <li>
...
export default {
  ...
  methods:{
	  getDataList(){
		  var that = this
		  that.$ajax.get('/analysis?user_id='+that.patientId)
		  .then(function(res){
