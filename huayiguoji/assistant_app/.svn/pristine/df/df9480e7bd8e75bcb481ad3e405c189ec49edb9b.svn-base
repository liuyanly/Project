		...
		<ul class="list-ul">
			<li class="clear">
				<div class="left img-box">
					<img v-if="data.type == 'doctor'" :src="info.translates.avatar_img" />
					<img v-else src="../assets/images/b1_icon4.png" />
					<!-- <span class="num">22</span> -->
				</div>
				<div class="left word">
					<p class="line1 clear">
						<span v-if="data.type == 'doctor'" class="left">{{info.realname}}</span>
