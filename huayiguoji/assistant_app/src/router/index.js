...
import ChooseTemplate from '@/healthmanage/ChooseTemplate' // 选择模板
...
import MyMember from '@/healthmanage/MyMember' //我的患者
...
export default new Router({
    routes: [{
        ...
        {
            path: '/ChooseUser/:type/:patientId/:userId/:title',
            name: 'ChooseUser',
            component: ChooseUser
        },
        {
            path: '/ChooseAssistant/:type/:patientId/:userId',
        ...
        {
            path: '/DistributionTask/:patientId/:userId',
            name: 'DistributionTask',
            component: DistributionTask
        },
        {
            path: '/PatientDetail/:type/:patientId/:userId',
            name: 'PatientDetail',
            component: PatientDetail
        },
        {
            path: '/ChooseAssistantDetail/:patientId/:userId',
            name: 'ChooseAssistantDetail',
            component: ChooseAssistantDetail
        },
        {
            path: '/SignAssistantDetail/:patientId/:userId',
        ...
        {
            path: '/SignDistribution/:patientId/:userId',
