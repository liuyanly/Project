        ...
        <ul class="template-list">
            <li :class="{current:moreId==data.category_id}" v-for="data in dataList">
                ...
                <div class="content clear">
                    ...
                    <img v-if="moreId!=data.category_id" class="right xiala-img" src="@/assets/images/a22_xiala@2x.png" @click="viewMore(data.category_id)"/>
                    <img v-if="moreId==data.category_id" class="right xiala-img" src="@/assets/images/a22_xiala_p@2x.png" @click="viewMore(0)"/>
                </div>
            </li>
        </ul>
    </div>
    ...
    export default {
        ...
        methods:{
            ...
            chooseThis(id,content,title){
                this.BaseSet.setInfo('followContent',content)
                this.$router.push({name:'PublishFollow',params:{id:id,title:title}})
            },
            getList(){
                this.$ajax.get('/visit/temp/'+this.id)
                .then((res)=>{
