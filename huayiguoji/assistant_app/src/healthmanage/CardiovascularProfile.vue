<template>
	<div class="Risk_detail">
        ...
        <div class="contentScollr">
            ...
            <div v-if="typeof str === 'string'">
                <div class="chart-box tips_box">
...
export default {
  ...
  methods:{
    ...
    getData(){
        var that = this
        that.$ajax.get('/check/ascvd/'+that.patientId)
        .then(function(res){
            ...
            if(res.data.status == 200){
              ...
              setTimeout(function() {
                ...
                that.str = that.ascvdObj.cvd_10yearRisk;
