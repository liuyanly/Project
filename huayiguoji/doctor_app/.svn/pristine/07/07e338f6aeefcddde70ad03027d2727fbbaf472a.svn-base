...
export default {
  ...
  mounted(){
	  ...
	  this.getData('/visit/user/'+this.id+'?per_page='+this.per_page+'&page='+this.currentPage)
  },
  methods:{
	  loadBottom() {
		  ...
		  if(this.pickerValue!='全部'){
			  this.getData('/visit/user/'+this.id+'?per_page='+this.per_page+'&page='+this.currentPage+'&m_s[created_at]='+this.pickerValue)
		  }else{
			  this.getData('/visit/user/'+this.id+'?per_page='+this.per_page+'&page='+this.currentPage)
		  }
