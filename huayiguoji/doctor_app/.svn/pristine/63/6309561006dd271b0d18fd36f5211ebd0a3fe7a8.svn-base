          ...
          if (data.status == 200) {
            ...
            if (!sessionStorage.getItem("department")) {
              sessionStorage.setItem(
                "department",
                res.data.data.translates.department_title
              );
            } else {
              this.department = sessionStorage.getItem("department");
            }
            if (!sessionStorage.getItem("hospital")) {
              sessionStorage.setItem(
                "hospital",
                res.data.data.translates.hospital_title
              );
            } else {
              this.hospital = sessionStorage.getItem("hospital");
            }
...
.my-data {
  ...
  .head-top {
    padding: 0.5rem /* 21/40 */ 0.8rem /* 30/40 */;
    background: #fff;
    margin-bottom: 0.6rem /* 22/40 */;
    .name {
