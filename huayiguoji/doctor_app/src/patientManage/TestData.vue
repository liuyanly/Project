    ...
    <div class="test-data">
        ...
        <div class="filter-box">
            <ul class="head-list" :style="ulHeight">
                <li v-for="data in abnormalData" :class="{current:title==data.name}" @click="changeId(data.name)">{{data.name}}<span class="tag" >{{data.count}}</span></li>
            </ul>
