      ...
      <div class="way-box">
        ...
        <p class="pay-way clear" v-for="vipItem in userVipList">
          ...
          <label for="payWay4">
            ...
            <span class="title left">会员
              <span class="tip">(支付1次,剩余{{vipItem.residue}}次)</span>
            </span>
          </label>
        </p>
        ...
        <p class="pay-way clear" v-for="(vipItem,index) in departmentVipList">
          ...
          <label :for="'payWayd4'+index">
            <img class="left" src="../assets/images/c14_icon3.png"/>
            <span class="title left">{{vipItem.name}}企业会员
              <span class="tip">(支付1次,剩余{{vipItem.residue}}次)</span>
            </span>
          </label>
        </p>
        ...
        that.$ajax
          ...
          .then(function (res) {
            if (res.data.status == 200) {
              ...
              that.doctor_id=that.translates.doctor_account.id
            ...
            for (var i = 0; i < userVip.family_vips.length; i++) {
              if (userVip.family_vips[i].id != userInfo.id) {
                ...
                var temp = {
                  ...
                  residue:
                    userVip.family_vips[i].translates.vips.pivot.permissions[
                      that.BaseSet.vippermissions.dianhua
                      ],
                  totalresidue: that.timeId
                };
    ...
    .way-box {
      ...
      .pay-way {
        ...
        .one_sel {
          ...
          &:checked + label:after {
            content: "";
            background: transparent url("../assets/images/c14_xz.png") no-repeat center center;
