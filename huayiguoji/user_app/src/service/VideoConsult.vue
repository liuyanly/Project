        ...
        <div class="contentScollr">
            <div class="inner-box">
                <div class="top-box">
                    ...
                    <p class="name">
                        {{data.realname}}
                        <span class="c1">({{department_title+' '+jobtitle}})</span>
                    </p>
      ...
      that.$ajax
        ...
        .then(function(res) {
          if (res.data.status == 200) {
            ...
            that.headImg = that.data.translates.avatar_img;
            that.department_title = that.data.translates.department_title;
            that.jobtitle = that.data.jobtitle;
            that.hospital_title = that.data.translates.hospital_title;
