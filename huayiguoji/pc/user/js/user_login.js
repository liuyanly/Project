...
Vue.component('login-box', {
    template: '<div class="fade2" v-show="loginType==1">' +
        '<div class="login-box">' +
        ...
        '<p class="forget-psw" onclick="window.location.href=\'../user/forget_password.html\'">忘记密码？</p>' +
    ...
    methods: {
        nowLogin: function() {
            ...
            if (this.telNum.length != 11 || !(/^1\d{10}$/.test(this.telNum))) {
