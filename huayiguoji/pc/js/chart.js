                    ...
                    normal: {
                        color: {//背景填充色
                            ...
                            colorStops: [{
                                ...
                                offset: 1, color: '#FC4F4F' // 100% 处的颜色
                            }],
...
function twoLine(x_data,data1,data2,id) {
    var option = {
        tooltip : {
            trigger: 'axis'
        },
        legend: {//图例
            ...
            data:[
                {
                    name:'收缩压',
                    icon:'image://../images/a1_q_dian_p.png',//图例图形形状
                    textStyle:{//图例文字样式
                        fontSize:16,
                        color:'#666'
                    }
                ...
                {
                    name:'舒张压',
                    icon:'image://../images/a1_q_dian.png',
                    textStyle:{
                        fontSize:16,
                        color:'#666'
                    },
        ...
        series : [
            {
                ...
                label: {
                    normal: {
                        show:true,
                        backgroundColor: {image: '../images/a1_cheng.png'},
                        color:'#fff',
                        fontSize:13,
                        padding:[5,5,10,5],
                    }
            ...
            },
            {
                ...
                label: {
                    normal: {
                        show:true,
                        backgroundColor: {image: '../images/a1_cheng1.png'},
                        color:'#fff',
                        fontSize:13,
                        padding:[5,5,10,5],
                    }
