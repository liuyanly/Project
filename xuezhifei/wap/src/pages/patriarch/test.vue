            ...
            <div class="topic-wapper">
                <div class="topic" ref="topic-hook">
                    <div class="topic-item" v-for="(testingItem, testingIndex) in testingItems">
                        ...
                        <!-- <div class="topic-content" v-for="(item, index) in testingItem.option_html_list">
                            <div class="topic-radio">
                                <i class="icon-radio" :class="[(testingItem.result == true) && (testingIndex == index)? 'checked' : '']" @click="isRadiio(testingItem,item,index)" :value="item.split('、')[0]"></i>
                            </div>
...
export default {
  data() {
        return {
            ...
            releaseId: this.$util.baseset.getInfo('release_id'),
            testingItems: [],
            // radioIndex: '',
            testingId: [],
            testingResult: [],
    ...
    methods: {
        ...
        //     praentEle.result = !praentEle.result;
        // },
        iscollect(e) {
            var that = this;
